...
"""
# To ignore all (C)onvention and (R)efactor messages for this file:
# pylint: disable=C,R
...
def update(data={}):  # pylint: disable=dangerous-default-value
    """Update the data"""
...
class Dragon:
    ...
    def __init__(some):  # pylint: disable=no-self-argument
        pass
